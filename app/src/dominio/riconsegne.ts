...
import { allieviAttivi } from './calcoli.js'
import { rigaDelRecupero } from './recuperi.js'
import { differenzaGiorni } from './date.js'
import type { Allievo, Classe, Iso, MomentoValutazione, Registro, Voto } from './modelli.js'
...
export function riconsegnaDelMomento (
  ...
  return {
    ...
    stato,
    giorniPassati,
    inRitardo: stato !== 'riconsegnata' && giorniPassati > GIORNI_PER_RICONSEGNARE,
    corretti,
