...
import { allaProiezione, PannelloProiezione, statoProiezione } from './proiezione.js'
import type { MessaggioNavigazione, MessaggioVersoWebview, Richiesta } from '../protocollo.js'
import { paginaHtml, radiceRisorse, radiciDellaPagina } from './pagina.js'
...
export class PannelloRegistro {
  ...
  static mostra (
    ...
    pannello.iconPath = vscode.Uri.joinPath(contesto.extensionUri, 'risorse', 'registro.svg')
