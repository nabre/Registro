// A che punto è un'ora del suo giro.
//
// È la distinzione che il menu del vassoio mette sotto gli occhi — svolta, da
// chiudere, in corso, futura — e sbagliarla ha due costi opposti: un'ora a
// posto segnata «da chiudere» manda a riaprire un registro già finito, e un
// buco segnato «svolta» lo fa sparire.

import assert from 'node:assert/strict'
import { describe, it } from 'node:test'

import { creaLezione, faseDellOra, raggruppaOre } from '../../dist-prove/dominio.mjs'
...
describe('la fase di un’ora', () => {
  it('futura e con un piano: futura', () => {
