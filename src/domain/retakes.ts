...
export function statoDelRecupero (
  ...
  //
  // Vale anche senza una riga di recupero, e è il caso normale: l'assenza si
  // deduce dall'appello, nessuno ha dovuto fissare niente, e il voto si scrive
  // dritto nella tabella dei recuperi. Guardando la sola riga quel recupero
  // tornava `null` nell'istante in cui lo si registrava — la riga spariva
  // dalla tabella invece di passare a «recuperata», e la sua riconsegna non
  // era più raggiungibile da nessuna parte.
