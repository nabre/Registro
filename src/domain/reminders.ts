...
export function oreCheCominciano (
  ...
  return registro.lezioni
    ...
    // Un giorno solo, quindi la data pareggia sempre: si usa lo stesso
    // comparatore di tutti gli altri elenchi di ore perché sia lui, e non il
    // caso, a decidere l'ordine di due ore che cominciano insieme.
