...
function accorciato (contenuto: string, largo: number): string {
  ...
  let corto = contenuto
  while (corto.length > 1 && larghezzaTesto(`${corto}…`, 'piccolo') > largo)
...
function gruppoLaterale (y: number, nome: string): string {
  return testo(18, y, accorciato(nome, 118), {
    corpo: 'piccolo',
    tono: 'quieto',
    forte: true,
  })
...
function pastigliaCerca (destra: number, y: number): string {
  ...
  const largo =
    30 +
    larghezzaTesto(parola, 'piccolo') +
    larghezzaTesto(tasto, 'piccolo', true) +
    8
...
function filaDiPulsanti (
  ...
  pulsanti: readonly {
    nome: string;
    largo: number;
    tono: 'neutro' | 'accento' | 'quieto';
  }[],
): string {
  let cursore = x
  return disegno(
    ...pulsanti.map(({ nome, largo, tono }) => {
...
function rigaDelleScelte (): string {
  ...
  const modifica = Math.min(
    496,
    proietta - 4 - largaPastiglia(parole().modifica),
  )
  return disegno(
      ...
      figure: [
        {
          ...
          disegno: disegno(
            catena(
              ...
              [
                {
                  etichetta: T.primiPassi.scritte.benvenuto,
                  sotto: T.primiPassi.scritte.nuovoAnno,
                },
                {
                  etichetta: T.primiPassi.scritte.classi,
                  sotto: T.primiPassi.scritte.eCorsi,
                },
                { etichetta: parole().salva, sotto: 'Ctrl+S' },
                {
                  etichetta: T.primiPassi.scritte.elenco,
                  sotto: T.primiPassi.scritte.inClassi,
                },
                {
      ...
      figure: [
        {
          ...
          disegno: disegno(
            catena(
              ...
              [
                {
                  etichetta: T.inizio.scritte.anno,
                  sotto: '2026-2027.regi',
                  simbolo: 'calendario',
                },
                {
                  etichetta: T.inizio.scritte.classe,
                  sotto: T.inizio.scritte.ilGruppo,
                  simbolo: 'classi',
                },
                {
                ...
                {
                  etichetta: T.inizio.scritte.orario,
                  sotto: T.inizio.scritte.oreFisse,
                  simbolo: 'settimana',
                },
              ],
              { largo: 130, stacco: 26 },
            ...
            riquadro(10, 105, 130, 40, {
              tono: 'quieto',
              etichetta: T.inizio.scritte.materia,
              sotto: T.inizio.scritte.dalCatalogo,
            }),
            freccia([
              [140, 125],
              [387, 125],
            ...
            riquadro(478, 105, 130, 40, {
              tono: 'positivo',
              etichetta: T.inizio.scritte.lezioni,
              sotto: T.inizio.scritte.sulCalendario,
            }),
            freccia([
              [543, 64],
              [543, 101],
      ...
      figure: [
        {
          ...
          disegno: disegno(
            telaio(10, 10, 620, 300, {
              titolo: '',
              stato: T.finestra.scritte.stato,
            }),
            ...
            testo(38, 25, T.finestra.scritte.file, {
              corpo: 'piccolo',
              forte: true,
            }),
            ...
            testo(35, 47, T.finestra.scritte.registro, {
              corpo: 'piccolo',
              forte: true,
            }),
            ...
            paginaLaterale(70, testiPagine().dashboard),
            ...
            filo(140, 88, 490),
            // La pagina.
            ...[0, 1, 2, 3, 4].map((giorno) =>
              disegno(
                riquadro(152 + giorno * 92, 100, 84, 180, {
                  tono: 'quieto',
                  raggio: 4,
                }),
      ...
      figure: [
        {
          ...
          disegno: disegno(
            ...
            testo(164, 84, T.ricerca.scritte.nuovaOra, {
              forte: true,
              tono: 'accento',
            }),
            ...
            testo(164, 160, T.ricerca.scritte.nuovaConsegna, {
              forte: true,
              tono: 'quieto',
            }),
        ...
        },
        {
          ...
          disegno: disegno(
            ...
            titolettoPalette(
              62,
              Molti(lessico().pif),
              testiPalette().diTanti(6, 21),
            ),
            rigaPalette(
              68,
              'utente',
              T.ricerca.scritte.persona1,
              T.ricerca.scritte.classe,
              true,
            ),
            rigaPalette(
              104,
              'utente',
              T.ricerca.scritte.persona2,
              T.ricerca.scritte.classe,
            ),
            ...
            rigaPalette(
              160,
              'libro',
              T.ricerca.scritte.corso,
              testiPalette().schedaDelCorso,
            ),
      ...
      figure: [
        {
          vista: '0 0 640 128',
          disegno: disegno(
            testo(10, 12, T.barraStato.scritte.aSinistra, {
              corpo: 'piccolo',
              tono: 'quieto',
            }),
            ...
            testo(238, 99, T.barraStato.scritte.assistente, {
              corpo: 'piccolo',
              tono: 'positivo',
            }),
            simbolo('posta', 372, 88, 14, 'positivo'),
            testo(390, 99, T.barraStato.scritte.casella, {
              corpo: 'piccolo',
              tono: 'positivo',
            }),
        ...
        },
        {
          ...
          disegno: disegno(
            riquadro(10, 20, 150, 44, {
              tono: 'quieto',
              etichetta: T.barraStato.scritte.leOre,
