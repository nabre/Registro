...
/**
 * Le prove del corso ancora in mano a chi insegna, dentro il registro della lezione.
 *
  ...
  return h(
    ...
    classe && daRiempire.length > 0
      ? h(
          ...
          titoloGruppo('Da completare', daRiempire.length, 'h5'),
    ...
    singoli.length > 0
      ? h(
          ...
          titoloGruppo('Da ridare a', singoli.length, 'h5'),
    ...
    recuperi.length > 0
      ? h(
          'div',
          { class: 'riconsegne__singoli' },
          titoloGruppo('Recuperi da ridare', recuperi.length, 'h5'),
