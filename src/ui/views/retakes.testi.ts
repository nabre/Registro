...
const it = {
  ...
  resaIl: 'resa il',
  giornoRiavuta: (nome: string) => `Il giorno in cui ${nome} ha riavuto la prova rifatta`,
  rifaIl: (giorno: string) => `Rifà la prova il ${giorno}, prossima ora del corso`,
  ...
  votoAiuto: 'Il voto preso rifacendo la prova: va nella colonna di questa verifica',
  /** Il segnaposto del campo data: come si scrive un giorno. */
  formatoData: 'gg.mm.aaaa',
  apri: (file: string) => `Apri ${file}`,
  allegaScansione: (nome: string) => `Allega la scansione del recupero di ${nome}`,
...
export const testi = catalogo(it, {
  de: {
    ...
    giornoRiavuta: (nome) => `Der Tag, an dem ${nome} die nachgeholte Prüfung zurückbekommen hat`,
    rifaIl: (giorno) =>
      `Holt die Prüfung am ${giorno} nach, in der nächsten Stunde des Kurses`,
    decidi: 'Tag ansetzen, eine Notiz schreiben oder festhalten, dass es keine Nachprüfung gibt',
    riconsegnataIl: (giorno) => `Zurückgegeben am ${giorno}`,
    nonEraTornata: 'Wurde nicht zurückgegeben: Leg sie wieder zu denen, die noch zurückzugeben sind',
    ...
    votoAiuto: 'Die Note der nachgeholten Prüfung: Sie kommt in die Spalte dieser Prüfung',
    ...
    scansione: 'Scan',
    daFissareInSospeso: (daFissare, aperti) => `${daFissare} anzusetzen · ${aperti} offen`,
  ...
  fr: {
    ...
    resaIl: 'rendue le',
    giornoRiavuta: (nome) => `Le jour où l’épreuve refaite a été rendue à ${nome}`,
    rifaIl: (giorno) => `Refait l’épreuve le ${giorno}, à la prochaine leçon de ce cours`,
    decidi: 'Fixer le jour, écrire une note, ou déclarer qu’il n’y aura pas de rattrapage',
    riconsegnataIl: (giorno) => `Rendue le ${giorno}`,
    nonEraTornata: 'Elle n’avait pas été rendue : remets-la parmi celles à rendre',
    ...
    votoAiuto: 'La note obtenue en refaisant l’épreuve : elle va dans la colonne de cette épreuve',
    ...
    scansione: 'Scan',
    daFissareInSospeso: (daFissare, aperti) => `${daFissare} à fixer · ${aperti} en suspens`,
  ...
  en: {
    ...
    rifaIl: (giorno) => `Resits the test on ${giorno}, the course’s next lesson`,
    ...
    votoAiuto: 'The grade from resitting the test: it goes in this test’s column',
    ...
    scansione: 'Scan',
    daFissareInSospeso: (daFissare, aperti) => `${daFissare} to schedule · ${aperti} pending`,
