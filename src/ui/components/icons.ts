...
const TRACCIATI: Record<string, string> = {
  ...
  // dove andrà il bordo.
  sidebarRiduci: '<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M9 4v16"/><path d="M15.5 9.5 13 12l2.5 2.5"/>',
  sidebarEspandi: '<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M9 4v16"/><path d="M13 9.5l2.5 2.5-2.5 2.5"/>',
  ...
  registro: '<path d="M13.8 4.205A8 8 0 1 1 8.874 19.364"/><path d="M5.962 17.248A8 8 0 0 1 5.143 16.12"/><path stroke-opacity="0.45" d="M4.03 12.697A8 8 0 0 1 10.2 4.205"/><circle cx="12" cy="12" r="1.4" fill="currentColor" stroke="none"/>',
  ...
  ripristina: '<path d="m15 14 5-5-5-5"/><path d="M20 9H9.5a5.5 5.5 0 0 0 0 11H13"/>',
  // Il registro come oggetto (quaderno col dorso), nella testata della barra
  // laterale; il logo sta nella barra del titolo.
  libro: '<path d="M4 4.5A1.5 1.5 0 0 1 5.5 3H19v16H5.5A1.5 1.5 0 0 0 4 20.5z"/><path d="M4 20.5A1.5 1.5 0 0 1 5.5 19H19v2H5.5A1.5 1.5 0 0 1 4 20.5z"/><path d="M8 7h7M8 10.5h7M8 14h4"/>',
  ...
  // Il sole: la pagina «Oggi». Tracciato di Lucide («sun», licenza ISC,
  // https://lucide.dev).
...
export function tracciatoIcona (nome: NomeIcona): string {
  return Object.hasOwn(TRACCIATI, nome) ? TRACCIATI[nome] : TRACCIATI.informazione
}
