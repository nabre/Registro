...
const it = {
  ...
  gruppi: {
    ...
    modificaLeOre: 'Modifica le lezioni',
    calendarioIcs: 'Calendario ICS',
    cheCosaSiGuarda: 'Che cosa si guarda',
    crea: 'Crea',
    statoDellOra: 'Stato della lezione',
    ora: 'La lezione',
    piano: 'Il piano',
    check: 'Il check',
    indirizzi: 'Indirizzi',
...
export const testi = catalogo(it, {
  de: {
    ...
    dallaSuaPagina:
      'Das geht auf der eigenen Seite: Öffne sie, und du findest es in der Leiste.',
  ...
  fr: {
    ...
    dallaSuaPagina:
      'Cela se fait depuis sa page : ouvre-la, et tu le trouves dans la barre.',
  ...
  en: {
    ...
    dallaSuaPagina:
      'This is done from its own page: open it, and you’ll find it in the bar.',
