  ...
  apriModale({
    ...
    azioniSecondarie: (contesto) =>
      pulsante({
        ...
        variante: 'fantasma',
        al: () => {
          // I valori si rileggono dai campi, non da `recupero`, che è com'era
          // all'apertura. Chi scrive una nota — «assente giustificata, non si
          // recupera» — e poi preme questo pulsante la scrive proprio *per*
          // questo gesto: prendendo la nota di prima si buttava via l'unica
          // cosa che stava spiegando, e in silenzio.
          ...
          return recupero.stato === 'dispensato'
            ...
            : manda(contesto, null, nota, true, 'La prova non si recupera.', riconsegnataIl)
        },
      }),
  })
}
