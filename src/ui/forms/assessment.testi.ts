...
const it = {
  ...
  aiutoData: 'Nasce dalla lezione della prova; si sposta solo per un recupero.',
  peso: 'Peso',
  aiutoPeso:
    'Quanto conta nella media: da 0 a 10, decimali ammessi. Zero non fa media.',
...
export const testi = catalogo(it, {
  de: {
    ...
    aiutoProvenienza:
      'Die Verknüpfung entsteht im Ablauf: Geändert wird sie dort, nicht hier.',
    ...
    aiutoData:
      'Kommt von der Stunde der Prüfung; verschieben nur für eine Nachprüfung.',
    peso: 'Gewichtung',
    aiutoPeso:
  ...
  fr: {
    ...
    aiutoProvenienza:
      'C’est le déroulement qui fait le lien : il se change là-bas, pas ici.',
    ...
    aiutoData:
      'Vient de la leçon de l’épreuve ; ne se déplace que pour un rattrapage.',
    peso: 'Pondération',
    aiutoPeso:
  ...
  en: {
    ...
    peso: 'Weight',
    aiutoPeso:
      'How much it counts in the average: 0 to 10, decimals allowed. Zero leaves it out.',
