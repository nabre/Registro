...
import {
  allieviAttivi, nomeCompleto, ordinaAllievi, slotIncatenati, slotOrdinati,
...
import { creaLezione, creaOsservazione, creaSlot } from '../../domain/factories.js'
import type { Classe, Lezione, Osservazione, Slot } from '../../domain/models.js'
import { campo, pastiglia, pulsante, riga, sezioneModulo } from '../components/base.js'
