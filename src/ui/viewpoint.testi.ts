...
const it = {
  ...
  campi: {
    ...
    pendenzeMostrate: 'Pendenze mostrate',
    classePendenze: 'Classe delle pendenze',
    consegneMostrate: 'Consegne mostrate',
...
export const testi = catalogo(it, {
  de: {
    campi: {
      ...
      pendenzeMostrate: 'Angezeigte Pendenzen',
      classePendenze: 'Klasse der Pendenzen',
      consegneMostrate: 'Angezeigte Aufträge',
  ...
  fr: {
    campi: {
      ...
      pendenzeMostrate: 'Tâches en suspens affichées',
      classePendenze: 'Classe des tâches en suspens',
      consegneMostrate: 'Devoirs affichés',
  ...
  en: {
    campi: {
      ...
      pendenzeMostrate: 'Pending items shown',
      classePendenze: 'Class of the pending items',
      consegneMostrate: 'Assignments shown',
