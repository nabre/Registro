 ...
 * colonna non comanda niente, ma `panels/panel.ts` e `panels/projection.ts` la
 ...
 * `dialogs.ts`: `Notification` è l'unico caso che il registro usa davvero.
 */
export enum DoveAvanzamento {
  SourceControl = 1,
  Window = 10,
  Notification = 15,
}
