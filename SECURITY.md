...
Il Registro docenti custodisce dati di persone reali, spesso minorenni. Una
...
- lettura o scrittura di un documento `.registro` da parte di chi non dovrebbe;
- il condotto JSON-RPC e `regdoc`: permessi di lettura e scrittura aggirati,
