...
# che non scriverlo.
campi: Stato={{stato}}; Data di nascita={{nascita}}; Indirizzo={{indirizzo}}; E-mail={{email}}; Telefono={{telefoni}}; Rappr. legale={{tutore}}; Azienda formatrice={{azienda}}; Indirizzo dell'azienda={{indirizzoDatore}}; Datore di lavoro={{datore}}; Telefono del rappresentante={{telefoniRappresentante}}; Telefono del datore={{telefoniDatore}} | colonne 1
