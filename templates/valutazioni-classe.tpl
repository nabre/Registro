...
[corpo]
usa: apertura | titolo={{titolo}} — {{classe}}; sottotitolo={{materia}} · {{periodo}} · {{quanti}} momenti di valutazione

sezione: Voti e medie
tabella: voti
...
sezione: Esecuzione e riconsegna
...
sezione: Prove ancora da ridare
tabella: daRidare
