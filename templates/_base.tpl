...
#   {{sede}}     la scuola o il reparto, dall'intestazione del documento
#   {{docente}}  chi firma, dall'intestazione del documento
...
# segreteria si nota.
immagine: logo.png | altezza 14 | destra
...
# pezzi di frase.
riga: | | {{sede}}
riga: {{frase.registro-scolastico}} | | {{materia}}
riga: **{{titolo}}** | | {{classe}} · {{anno}} · {{periodo}}

[piede]
# Chi firma a sinistra, quando è stato composto in mezzo, dove si è nel
# documento a destra. «{{docente}}» viene dall'intestazione del documento,
# accanto alla sede: è il nome che va sotto ogni foglio che esce, e non
# cambia da un rapporto all'altro.
riga: {{docente}} | {{generato}} | {{frase.pagina-di-pagine}}
