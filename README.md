...
sette documenti indicizzati da [docs/INDICE.md](docs/INDICE.md):
[ARCHITETTURA](docs/ARCHITETTURA.md), [MODELLO-DATI](docs/MODELLO-DATI.md),
[CATALOGO](docs/CATALOGO.md), [API](docs/API.md), [DECISIONI](docs/DECISIONI.md),
[IMPIANTO](docs/IMPIANTO.md) e [CANTIERE](docs/CANTIERE.md) — gli ultimi due
...
[docs/CANTIERE.md](docs/CANTIERE.md) dice **che cosa sta cambiando adesso** —
...
sta in [docs/CATALOGO.md](docs/CATALOGO.md). Qui non si ricopia: una tabella
...
scorciatoia dove c'è — sta in [docs/CATALOGO.md](docs/CATALOGO.md) § 4. Come per
