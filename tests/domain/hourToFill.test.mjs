// Quale ora la barra di stato propone, e in che ordine: un'ora passata senza
// appello viene prima della prossima lezione.

import assert from 'node:assert/strict'
import { describe, it } from 'node:test'

import { creaLezione, creaValutazione, oraDaCompilare } from '../../dist-tests/domain.mjs'
...
/**
 * Segna l'ora come fatta e con l'appello preso. Uno stato per UD, come nel
 * registro: `stati` vuoto o indeciso è un appello *non* fatto, quel che
