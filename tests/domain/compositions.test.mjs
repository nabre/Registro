// I fascicoli composti: dove finiscono, e che cosa si accetta come ricetta.
//
// La ricetta è l'unica cosa del fascicolo che non si può ricomporre da sola: il
// PDF si rifà premendo un pulsante, l'elenco di che cosa ci sta dentro no. Per
// questo si legge con diffidenza — un JSON toccato a mano, o scritto da una
// versione di prima, non deve diventare un fascicolo di zero pagine con il nome
// giusto, che è il modo peggiore di sbagliare.
