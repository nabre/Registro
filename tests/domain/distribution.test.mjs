// Distribuire un documento, e raccoglierne uno. Il file e il gesto sono due
// fatti distinti: avere la pagella di Rossi non vuol dire avergliela data, e
// un certificato portato non vuol dire scansionato.
...
describe('chi aspetta ancora', () => {
  it('è chi ha un documento pronto e non l’ha ancora ricevuto', () => {
    ...
    // Verdi non aspetta: il suo documento non c'è ancora.
...
describe('il file e il gesto restano due cose', () => {
  it('i file scritti col formato di prima diventano documenti, e la spunta resta', () => {
    // Il formato vecchio teneva il file dentro la spunta.
    ...
    // Il file non è più dentro la spunta: una verità, in un posto solo.
