...
describe('una data dentro un nome di file', () => {
  ...
  // Il prefisso dei file in quarantena: tiene distinti due PDF arrivati con lo
  // stesso nome, e dice quando sono arrivati invece di una sigla in base 36.
  ...
  it('un nome senza data, o con una data che non esiste, non ne inventa una', () => {
    ...
    // Il numero deve stare in fondo e dietro un trattino basso: il resto del
    // nome è pieno di cifre, e una classe non è una data.
