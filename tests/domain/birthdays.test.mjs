// I compleanni delle persone in formazione.
//
// Sono due conti che sbagliano di rado ma sbagliano male: il giorno in cui la
// festa cade — e c'è il 29 febbraio, che tre anni su quattro non esiste — e
// quanti anni si compiono, che il giorno dei diciotto è il solo motivo per cui
// quel numero sta scritto sul calendario. Provati qui si verificano subito;
// provati a mano si verificano una volta all'anno, e solo per chi è nato quel
// giorno.
...
describe('gli anni compiuti', () => {
  it('non conta l’anno che deve ancora arrivare', () => {
    // Nata a ottobre: a settembre ne ha ancora diciassette, e la scheda che ne
    // scrivesse diciotto direbbe che le giustificazioni se le firma da sé.
  ...
  it('il 29 febbraio non sballa il conto', () => {
    // Il compleanno si festeggia il 28, ma gli anni si compiono lo stesso: al
    // primo di marzo di un anno non bisestile ne ha uno in più di sicuro.
