...
Esecuzione dalla cartella app: python tests/ui/staleEdits.py
"""
...
# Un piano con due tappe, sull'ora del primo corso. Costruito qui e non nel
# ponte di prova: serve solo a queste prove.
PREPARA = '''() => {
...
# Lo stesso piano cambiato altrove: una tappa in più. Un registro nuovo, come
# quello che l'host spinge dopo ogni scrittura.
CAMBIA_ALTROVE = '''() => {
  const r = prova.stato.registro
