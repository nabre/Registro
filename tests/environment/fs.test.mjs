// `file` dello shim, tre cose che sbagliate rompono il registro in silenzio: il
// codice `FileNotFound` (con cui `archive.ts` distingue «mai scritto» da
// «rotto»), il rifiuto di `rename` quando la destinazione esiste (una
// migrazione non passa sopra dei dati), e il tipo delle voci di una cartella
// (con cui `paths.ts` separa gli anni dai file).
