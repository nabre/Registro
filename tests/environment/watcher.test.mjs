...
//
// La prova che conta è la terza: `archive.ts` scrive i propri file e poi si
...
//
// Qui non si guarda un'API in astratto: si rifà quel che `archive.ts` fa
...
describe('la difesa contro l’eco delle proprie scritture', () => {
  ...
  it('l’uri annunciato è la stessa stringa di quello con cui si è scritto', async () => {
    ...
    try {
      // Composto come lo compone `paths.ts`: dalla radice, un segmento alla
