// I menu fatti di soli ruoli — «Modifica» e «Visualizza» — nel modello del menu.
//
// Si agganciavano davanti a un gruppo «Aiuto» che l'elenco dei gruppi non ha, e
// quindi non entravano mai: su macOS niente taglia, copia e incolla nei campi,
// e ovunque niente zoom né strumenti di sviluppo. Questa prova era rossa prima.
