...
import { allineaSemestri, annoAllineato } from '../../dominio/anni.js'
import { differenzaGiorni, formattaData, oggi, sommaGiorni } from '../../dominio/date.js'
import { creaSospensione } from '../../dominio/fabbriche.js'
import type { AnnoScolastico, Iso, Sospensione } from '../../dominio/modelli.js'
import { campo, pulsante, riga, sezioneModulo } from '../componenti/base.js'
  ...
  apriModale({
    ...
    azioniSecondarie: (contesto) =>
      modifica
        ? tastoElimina({
            contesto,
            chiedi: { genere: 'anno', id: anno!.id },
            azione: { tipo: 'anno.elimina', annoId: anno!.id },
            fatto: 'Anno eliminato.',
          })
        : null,
  })
}
