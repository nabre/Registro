...
import { MOTIVI_ORFANO, motivoOrfano } from '../../dominio/orfani.js'
import type { MomentoValutazione } from '../../dominio/modelli.js'
...
import { aggiorna, classeDelCorsoId, nomeCorso, pianoPerId, stato } from '../stato.js'
