// Rigenera `src/dati/modelliPredefiniti.ts` dal contenuto di `templates/`.
//
...
export const FILE_GENERATO = join(QUI, '..', 'src', 'dati', 'modelliPredefiniti.ts')
...
//
// Generato da \`templates/\` con \`npm run modelli\`: non si scrive a mano. Che i
