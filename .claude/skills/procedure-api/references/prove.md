...
- [I dieci file, e a che cosa servono](#i-dieci-file-e-a-che-cosa-servono)
...
## I dieci file, e a che cosa servono
...
```js
assert.equal(AZIONI.size, 142, `azioni trovate: ${AZIONI.size}`)   // il numero di oggi
```
